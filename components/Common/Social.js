...
const Social = () => {
  ...
  */}
      <Link href={`${BLOG.socialLink.github}`} scroll={false}>
        <span
          role="button" aria-label="Github"
          className="text-gray-400 hover:text-gray-500 active:text-gray-600 transition duration-100 cursor-pointer"
          onClick={(e) => {
            e.preventDefault();
            router.push(`${BLOG.socialLink.github}`);
          }}
        >
          <svg
            className='w-5 h-5'
