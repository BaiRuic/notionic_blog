  ...
  React.useEffect(() => {
    if (!waline) {
      waline = init({
        ...
        serverURL: BLOG.comment.walineConfig.host,
        lang: locale === 'en' ? 'en' : 'zh-cn',
        reaction: false, // 关闭文章反应
        search: false, // 关闭表情包搜索
        placeholder: '欢迎留言 bai',
        dark: 'html.dark',
        emoji: [
          '//npm.elemecdn.com/@waline/emojis@1.1.0/tieba',
          '//npm.elemecdn.com/@waline/emojis@1.1.0/weibo',
          '//npm.elemecdn.com/@waline/emojis@1.1.0/bilibili',
          //'//npm.elemecdn.com/@waline/emojis@1.1.0/qq',
          //'//npm.elemecdn.com/@waline/emojis@1.1.0/alus'
        ]
      })
    }
